...
public:
  enum {
    ...
    T__80 = 81, T__81 = 82, T__82 = 83, T__83 = 84, LBRACKET = 85, RBRACKET = 86, 
    LBRACE = 87, RBRACE = 88, LPAREN = 89, RPAREN = 90, COLON = 91, SEMICOLON = 92, 
    DOT = 93, COMMA = 94, EQUALS = 95, ARROW = 96, PLUS = 97, MINUS = 98, 
    MUL = 99, DIV = 100, MOD = 101, Constant = 102, Whitespace = 103, Newline = 104, 
    Integer = 105, Identifier = 106, RealNumber = 107, TimingLiteral = 108, 
